...
__attribute__((used)) int colorer_load_hrc_settings(void* handle, const char* path);
__attribute__((used)) int colorer_set_file_type(void* handle, const char* name);
__attribute__((used)) const char* colorer_file_type(void* handle);
__attribute__((used)) const char* colorer_get_file_type_param(void* handle, const char* type_name, const char* param);
__attribute__((used)) int colorer_set_file_type_param(void* handle, const char* type_name, const char* param, const char* value);
__attribute__((used)) int colorer_reset_file_type_param(void* handle, const char* type_name, const char* param);
__attribute__((used)) int colorer_file_type_params(void* handle, const char* type_name);
__attribute__((used)) const void* colorer_get_file_type_params(void* handle);
...
__attribute__((used)) int colorer_enum_file_types(void* handle);
__attribute__((used)) const char* colorer_get_file_type_name(void* handle, int index);
__attribute__((used)) const char* colorer_get_file_type_group(void* handle, int index);
__attribute__((used)) const char* colorer_get_file_type_description(void* handle, int index);
__attribute__((used)) int colorer_load_file_type(void* handle, const char* name);
